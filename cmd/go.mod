module netaddrs_discover

go 1.23.11

replace github.com/socheatsok78/go-discover-netaddrs => ../

require (
	github.com/hashicorp/go-discover v1.1.0
	github.com/socheatsok78/go-discover-netaddrs v0.0.0-00010101000000-000000000000
)
